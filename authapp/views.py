...
import re  # defined a URL pattern using a regular expressiion
...
from django.utils.encoding import force_bytes,force_str,DjangoUnicodeDecodeError #force_type is old version 
...
def signup(request):
    ...
    if request.method == "POST":
        ...
        if flag == 0:
            ...
            user.is_active=False  # [True] if user is active take mark, here is [False] No take mark
            user.save()
