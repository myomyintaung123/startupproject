...
def startupTrainingInstitute(request):
    return render(request, "s-t-i.html")
...
def contact(request):
    if request.method == "POST":
        ...
        query.save()
        messages.success(
            request, "Thanks for contactiong us we will get back you soon..."
        )
...
def enroll(request):
    ...
    # if this form is submitted  this below logic is going to work
    if request.method == "POST":
